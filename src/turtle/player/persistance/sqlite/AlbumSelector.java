...
public class AlbumSelector extends SelectorForSetSqlite<Sql, Album>
{
	@Override
	public Sql get()
	{
		return new Sql("SELECT DISTINCT " + TurtleDatabase.KEY_ALBUM + " FROM " + TurtleDatabase.TABLE_NAME);
	}
